...
namespace MotionControl
{
	 ...
	 * does not match the number of
        ...
        bool moveTraject();
	void setJointStiffness(float des_stiffness, float des_damping);
	...
	RTT::OutputPort<lwr_fri::FriJointImpedance> desired_joint_stiffness_outport;
    ...
    private:
        ...
        bool                                      is_moving,kinestetic_active;
